    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-slate-200/70 bg-white/80 p-6 shadow-sm dark:border-slate-700/60 dark:bg-slate-900/70">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-xl bg-slate-50 p-4 dark:bg-slate-800/60">
            <p className="text-sm text-slate-500 dark:text-slate-400">GPU Backend</p>
            <p className="text-lg font-medium text-slate-900 dark:text-slate-100">
              {hardware?.active_backend}
            </p>
          </div>
          <div className="rounded-xl bg-slate-50 p-4 dark:bg-slate-800/60">
            <p className="text-sm text-slate-500 dark:text-slate-400">Whisper Backend</p>
            <p className="text-lg font-medium text-slate-900 dark:text-slate-100">
              {hardware?.whisper_backend}
            </p>
          </div>
          <div className="rounded-xl bg-slate-50 p-4 dark:bg-slate-800/60">
            <p className="text-sm text-slate-500 dark:text-slate-400">Loading Strategy</p>
            <p className="text-lg font-medium text-slate-900 dark:text-slate-100">
              {hardware?.model_loading_strategy}
            </p>
          </div>
          <div className="rounded-xl bg-slate-50 p-4 dark:bg-slate-800/60">
            <p className="text-sm text-slate-500 dark:text-slate-400">Total VRAM</p>
            <p className="text-lg font-medium text-slate-900 dark:text-slate-100">
          ...
          {hardware?.unified_memory_gb && (
            <div className="rounded-xl bg-slate-50 p-4 dark:bg-slate-800/60">
              <p className="text-sm text-slate-500 dark:text-slate-400">Unified Memory</p>
              <p className="text-lg font-medium text-slate-900 dark:text-slate-100">
        ...
        {(hardware?.nvidia_gpus?.length || hardware?.amd_gpus?.length) && (
          <div className="mt-4">
            <p className="text-sm font-medium text-slate-700 dark:text-slate-200">Detected GPUs</p>
