  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="rounded-2xl border border-slate-200/70 bg-white/70 p-4 shadow-sm dark:border-slate-700/60 dark:bg-slate-900/60">
          <div className="hidden md:grid md:grid-cols-[minmax(0,2fr)_150px_120px_120px_140px] md:gap-4 border-b border-slate-200/70 pb-2 text-xs uppercase tracking-[0.2em] text-slate-400 dark:border-slate-700/60 dark:text-slate-500">
            <span>Video</span>
            <span>Status</span>
            <span>Duration</span>
            <span>Size</span>
      ...
      {data && data.total > 20 && (
        <div className="flex items-center justify-center space-x-4">
          <button
            ...
            disabled={page === 1}
            className="rounded-full border border-slate-200 px-4 py-2 text-sm font-medium text-slate-600 disabled:opacity-50 dark:border-slate-700 dark:text-slate-300"
          >
            Previous
          </button>
