...
- On heterogeneous NVIDIA hosts, `NVIDIA_VISION_VISIBLE_DEVICES` and `NVIDIA_SUMMARIZATION_VISIBLE_DEVICES` can pin the CUDA endpoint containers to specific cards when you do not want the default `all` visibility.
